...
from modules.classes import ENGLISH_POINTS, CHINESE_POINTS
...
class DeepSeekCommentAnalysisAgent:
    def __init__(self, ds_key, model='deepseek-chat'):
        self.model = model
    ...
    def get_comment_analyze_prompt(self):
        chinese_points = '<' + '>，<'.join(CHINESE_POINTS) + '>'  # <x>, <y>, <z> ....
...
if __name__ == '__main__':
    robot = DeepSeekCommentAnalysisAgent(openai_key='xxx', model="deepseek-chat")
